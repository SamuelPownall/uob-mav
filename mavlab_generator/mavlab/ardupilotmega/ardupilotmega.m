classdef ardupilotmega < uint16
    ...
    %Contains enumerators for the ardupilotmega MAVLINK XML file
    ...
    enumeration        
		...
		MAG_CAL_NOT_STARTED (0) %None
		MAG_CAL_WAITING_TO_START (1) %None
		MAG_CAL_RUNNING_STEP_ONE (2) %None
		MAG_CAL_RUNNING_STEP_TWO (3) %None
		MAG_CAL_SUCCESS (4) %None
		MAG_CAL_FAILED (5) %None
		PID_TUNING_ROLL (1) %None
		PID_TUNING_PITCH (2) %None
		PID_TUNING_YAW (3) %None
		PID_TUNING_ACCZ (4) %None
		PID_TUNING_STEER (5) %None
	end
