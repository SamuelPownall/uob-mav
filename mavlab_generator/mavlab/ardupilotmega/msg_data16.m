classdef msg_data16 < mavlink_message
	%MSG_DATA16(packet,type,len,data): MAVLINK Message ID = 169
    %Description:
    %    Data packet, size 16
	...
	properties
        ...
        data	%raw data	|	(uint8[16])
    end

    methods

        %Constructor: msg_data16
        %packet should be a fully constructed MAVLINK packet
        function obj = msg_data16(packet,type,len,data)
        ...
        function packet = pack(obj)
            ...
            if errorField == 0
                ...
                packet = mavlink_packet(msg_data16.LEN);
                packet.sysid = mavlink.SYSID;
                packet.compid = mavlink.COMPID;
                packet.msgid = msg_data16.ID;
