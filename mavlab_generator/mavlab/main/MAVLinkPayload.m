classdef MAVLinkPayload < MAVLinkHandle
%MAVLINKPAYLOAD: Represents the payload of a MAVLink packet
%Description:
...
%    and setting different data types and handles cases where data is of the incorrect type.
    ...
    methods
        ...
        function obj = MAVLinkPayload(payloadLength)
        %MAVLINKPAYLOAD: Create a new MAVLinkPayload object
        %Arguments:
