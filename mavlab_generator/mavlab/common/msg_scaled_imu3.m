classdef msg_scaled_imu3 < mavlink_handle
	%MSG_SCALED_IMU3(packet,time_boot_ms,xacc,yacc,zacc,xgyro,ygyro,zgyro,xmag,ymag,zmag): MAVLINK Message ID = 129
    %Description:
    ...
    methods
        ...
        function obj = msg_scaled_imu3(packet,time_boot_ms,xacc,yacc,zacc,xgyro,ygyro,zgyro,xmag,ymag,zmag)
