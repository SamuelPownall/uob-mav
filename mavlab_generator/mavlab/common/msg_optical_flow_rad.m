classdef msg_optical_flow_rad < mavlink_message
    ...
    methods
        ...
        function obj = msg_optical_flow_rad(packet)
        ...
        function set.time_usec(obj,value)
            if value == uint64(value)
                ...
                fprintf(2,'MAVLAB-ERROR | optical_flow_rad.set.time_usec()\n\t Input "value" is not of type "uint64"\n');
            end
        end
        ...
        function set.integration_time_us(obj,value)
            if value == uint32(value)
                ...
                fprintf(2,'MAVLAB-ERROR | optical_flow_rad.set.integration_time_us()\n\t Input "value" is not of type "uint32"\n');
            end
        end
        ...
        function set.time_delta_distance_us(obj,value)
            if value == uint32(value)
                ...
                fprintf(2,'MAVLAB-ERROR | optical_flow_rad.set.time_delta_distance_us()\n\t Input "value" is not of type "uint32"\n');
            end
        end
        ...
        function set.temperature(obj,value)
            if value == int16(value)
                ...
                fprintf(2,'MAVLAB-ERROR | optical_flow_rad.set.temperature()\n\t Input "value" is not of type "int16"\n');
            end
        end
        ...
        function set.sensor_id(obj,value)
            if value == uint8(value)
                ...
                fprintf(2,'MAVLAB-ERROR | optical_flow_rad.set.sensor_id()\n\t Input "value" is not of type "uint8"\n');
            end
        end
        ...
        function set.quality(obj,value)
            if value == uint8(value)
                ...
                fprintf(2,'MAVLAB-ERROR | optical_flow_rad.set.quality()\n\t Input "value" is not of type "uint8"\n');
            end
        end
