classdef common < uint16
    ...
    %Contains enumerators for the common MAVLINK XML file
    ...
    enumeration        
		...
		MAV_COMP_ID_ALL (0) %None
		MAV_COMP_ID_GPS (220) %None
		MAV_COMP_ID_MISSIONPLANNER (190) %None
		MAV_COMP_ID_PATHPLANNER (195) %None
		MAV_COMP_ID_MAPPER (180) %None
		MAV_COMP_ID_CAMERA (100) %None
		MAV_COMP_ID_IMU (200) %None
		MAV_COMP_ID_IMU_2 (201) %None
		MAV_COMP_ID_IMU_3 (202) %None
		MAV_COMP_ID_UDP_BRIDGE (240) %None
		MAV_COMP_ID_UART_BRIDGE (241) %None
		MAV_COMP_ID_SYSTEM_CONTROL (250) %None
		MAV_COMP_ID_SERVO1 (140) %None
		MAV_COMP_ID_SERVO2 (141) %None
		MAV_COMP_ID_SERVO3 (142) %None
		MAV_COMP_ID_SERVO4 (143) %None
		MAV_COMP_ID_SERVO5 (144) %None
		MAV_COMP_ID_SERVO6 (145) %None
		MAV_COMP_ID_SERVO7 (146) %None
		MAV_COMP_ID_SERVO8 (147) %None
		MAV_COMP_ID_SERVO9 (148) %None
		MAV_COMP_ID_SERVO10 (149) %None
		MAV_COMP_ID_SERVO11 (150) %None
		MAV_COMP_ID_SERVO12 (151) %None
		MAV_COMP_ID_SERVO13 (152) %None
		MAV_COMP_ID_SERVO14 (153) %None
		MAV_COMP_ID_GIMBAL (154) %None
		MAV_COMP_ID_LOG (155) %None
		MAV_COMP_ID_ADSB (156) %None
		...
		MAV_COMP_ID_QX1_GIMBAL (159) %None
		...
		MAVLINK_DATA_STREAM_IMG_JPEG (0) %None
		MAVLINK_DATA_STREAM_IMG_BMP (1) %None
		MAVLINK_DATA_STREAM_IMG_RAW8U (2) %None
		MAVLINK_DATA_STREAM_IMG_RAW32U (3) %None
		MAVLINK_DATA_STREAM_IMG_PGM (4) %None
		MAVLINK_DATA_STREAM_IMG_PNG (5) %None
		...
		MAV_CMD_AIRFRAME_CONFIGURATION (2520) %None
		...
		ADSB_EMITTER_TYPE_NO_INFO (0) %None
		ADSB_EMITTER_TYPE_LIGHT (1) %None
		ADSB_EMITTER_TYPE_SMALL (2) %None
		ADSB_EMITTER_TYPE_LARGE (3) %None
		ADSB_EMITTER_TYPE_HIGH_VORTEX_LARGE (4) %None
		ADSB_EMITTER_TYPE_HEAVY (5) %None
		ADSB_EMITTER_TYPE_HIGHLY_MANUV (6) %None
		ADSB_EMITTER_TYPE_ROTOCRAFT (7) %None
		ADSB_EMITTER_TYPE_UNASSIGNED (8) %None
		ADSB_EMITTER_TYPE_GLIDER (9) %None
		ADSB_EMITTER_TYPE_LIGHTER_AIR (10) %None
		ADSB_EMITTER_TYPE_PARACHUTE (11) %None
		ADSB_EMITTER_TYPE_ULTRA_LIGHT (12) %None
		ADSB_EMITTER_TYPE_UNASSIGNED2 (13) %None
		ADSB_EMITTER_TYPE_UAV (14) %None
		ADSB_EMITTER_TYPE_SPACE (15) %None
		ADSB_EMITTER_TYPE_UNASSGINED3 (16) %None
		ADSB_EMITTER_TYPE_EMERGENCY_SURFACE (17) %None
		ADSB_EMITTER_TYPE_SERVICE_SURFACE (18) %None
		ADSB_EMITTER_TYPE_POINT_OBSTACLE (19) %None
		ADSB_FLAGS_VALID_COORDS (1) %None
		ADSB_FLAGS_VALID_ALTITUDE (2) %None
		ADSB_FLAGS_VALID_HEADING (4) %None
		ADSB_FLAGS_VALID_VELOCITY (8) %None
		ADSB_FLAGS_VALID_CALLSIGN (16) %None
		ADSB_FLAGS_VALID_SQUAWK (32) %None
		ADSB_FLAGS_SIMULATED (64) %None
