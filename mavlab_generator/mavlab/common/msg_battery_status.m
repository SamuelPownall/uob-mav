classdef msg_battery_status < mavlink_message
    ...
    methods
		...
		function obj = msg_battery_status(packet,current_consumed,energy_consumed,temperature,voltages,current_battery,id,battery_function,type,battery_remaining)
            ...
            elseif nargin == 10
				...
				obj.current_consumed = current_consumed;
				obj.energy_consumed = energy_consumed;
				obj.temperature = temperature;
				obj.voltages = voltages;
				obj.current_battery = current_battery;
				obj.id = id;
				obj.battery_function = battery_function;
				obj.type = type;
