    ...
    methods
        ...
        function packet = pack(obj)
            ...
            if emptyField == 0
                ...
                packet = [];
                fprintf(2,'MAVLAB-ERROR | msg_scaled_pressure.pack()\n\t Message data in "%s" is not valid\n',emptyField);
            end
        ...
        function set.time_boot_ms(obj,value)
            if value == uint32(value)
                ...
                fprintf(2,'MAVLAB-ERROR | scaled_pressure.set.time_boot_ms()\n\t Input "value" is not of type "uint32"\n');
            end
        end
        ...
        function set.temperature(obj,value)
            if value == int16(value)
                ...
                fprintf(2,'MAVLAB-ERROR | scaled_pressure.set.temperature()\n\t Input "value" is not of type "int16"\n');
            end
        end
