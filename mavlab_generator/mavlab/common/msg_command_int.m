classdef msg_command_int < mavlink_message
    ...
    properties        
		...
		y	%PARAM6 / local: y position in meters * 1e4, global: longitude in degrees * 10^7 (int32[1])
		...
		command	%The scheduled action for the mission item. see MAV_CMD in common.xml MAVLink specs (uint16[1])
		target_system	%System ID (uint8[1])
		target_component	%Component ID (uint8[1])
		frame	%The coordinate system of the COMMAND. see MAV_FRAME in mavlink_types.h (uint8[1])
