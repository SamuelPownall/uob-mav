classdef msg_vision_position_estimate < mavlink_message
    ...
    methods
        ...
        function obj = msg_vision_position_estimate(packet)
        ...
        function packet = pack(obj)
            ...
            if emptyField == 0
                ...
                packet = [];
                fprintf(2,'MAVLAB-ERROR | msg_vision_position_estimate.pack()\n\t Message data in "%s" is not valid\n',emptyField);
            end
        ...
        function set.usec(obj,value)
            if value == uint64(value)
                ...
                fprintf(2,'MAVLAB-ERROR | vision_position_estimate.set.usec()\n\t Input "value" is not of type "uint64"\n');
            end
        end
