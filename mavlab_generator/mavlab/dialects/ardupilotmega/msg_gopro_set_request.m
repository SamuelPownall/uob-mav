classdef msg_gopro_set_request < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,target_system,target_component,cmd_id,value,varargin)

            if nargin == 4 + 1
                msg = msg_gopro_set_request(target_system,target_component,cmd_id,value,varargin);
            elseif nargin == 2
                msg = msg_gopro_set_request(target_system);
            else
    ...
    methods
        ...
        %MSG_GOPRO_SET_REQUEST: Create a new gopro_set_request message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_gopro_set_request.LEN);
