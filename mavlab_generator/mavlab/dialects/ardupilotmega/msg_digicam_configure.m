classdef msg_digicam_configure < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,extra_value,shutter_speed,target_system,target_component,mode,aperture,iso,exposure_type,command_id,engine_cut_off,extra_param,varargin)

            if nargin == 11 + 1
                msg = msg_digicam_configure(extra_value,shutter_speed,target_system,target_component,mode,aperture,iso,exposure_type,command_id,engine_cut_off,extra_param,varargin);
            elseif nargin == 2
                msg = msg_digicam_configure(extra_value);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_digicam_configure.LEN);
