classdef msg_fence_fetch_point < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,target_system,target_component,idx,varargin)
            ...
            if nargin == 3 + 1
                msg = msg_fence_fetch_point(target_system,target_component,idx,varargin);
            elseif nargin == 2
                msg = msg_fence_fetch_point(target_system);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_fence_fetch_point.LEN);
