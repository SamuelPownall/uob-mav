classdef msg_data32 < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,type,len,data,varargin)
            ...
            if nargin == 3 + 1
                msg = msg_data32(type,len,data,varargin);
            elseif nargin == 2
                msg = msg_data32(type);
            else
    ...
    methods
        ...
        function obj = msg_data32(type,len,data,varargin)
        %MSG_DATA32: Create a new data32 message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_data32.LEN);
