classdef msg_gimbal_set_home_offsets < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,target_system,target_component,varargin)
            ...
            if nargin == 2 + 1
                msg = msg_gimbal_set_home_offsets(target_system,target_component,varargin);
            elseif nargin == 2
                msg = msg_gimbal_set_home_offsets(target_system);
            else
    ...
    methods
        ...
        function obj = msg_gimbal_set_home_offsets(target_system,target_component,varargin)
        %MSG_GIMBAL_SET_HOME_OFFSETS: Create a new gimbal_set_home_offsets message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_gimbal_set_home_offsets.LEN);
                packet.sysid = MAVLink.SYSID;
                packet.compid = MAVLink.COMPID;
                packet.msgid = msg_gimbal_set_home_offsets.ID;
