classdef msg_data64 < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,type,len,data,varargin)
            ...
            if nargin == 3 + 1
                msg = msg_data64(type,len,data,varargin);
            elseif nargin == 2
                msg = msg_data64(type);
            else
    ...
    methods
        ...
        %MSG_DATA64: Create a new data64 message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_data64.LEN);
