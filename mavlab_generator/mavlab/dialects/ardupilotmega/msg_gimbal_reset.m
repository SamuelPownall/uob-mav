classdef msg_gimbal_reset < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,target_system,target_component,varargin)
            ...
            if nargin == 2 + 1
                msg = msg_gimbal_reset(target_system,target_component,varargin);
            elseif nargin == 2
                msg = msg_gimbal_reset(target_system);
            else
    ...
    methods
        ...
        function obj = msg_gimbal_reset(target_system,target_component,varargin)
        %MSG_GIMBAL_RESET: Create a new gimbal_reset message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_gimbal_reset.LEN);
