classdef msg_gimbal_request_axis_calibration < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,target_system,target_component,varargin)
            ...
            if nargin == 2 + 1
                msg = msg_gimbal_request_axis_calibration(target_system,target_component,varargin);
            elseif nargin == 2
                msg = msg_gimbal_request_axis_calibration(target_system);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_gimbal_request_axis_calibration.LEN);
