classdef msg_radio < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,rxerrors,fixed,rssi,remrssi,txbuf,noise,remnoise,varargin)
            ...
            if nargin == 7 + 1
                msg = msg_radio(rxerrors,fixed,rssi,remrssi,txbuf,noise,remnoise,varargin);
            elseif nargin == 2
                msg = msg_radio(rxerrors);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_radio.LEN);
