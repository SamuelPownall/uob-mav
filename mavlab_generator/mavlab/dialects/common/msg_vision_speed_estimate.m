classdef msg_vision_speed_estimate < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,usec,x,y,z,varargin)

            if nargin == 4 + 1
                msg = msg_vision_speed_estimate(usec,x,y,z,varargin);
            elseif nargin == 2
                msg = msg_vision_speed_estimate(usec);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_vision_speed_estimate.LEN);
