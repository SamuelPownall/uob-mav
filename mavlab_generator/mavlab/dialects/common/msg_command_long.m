classdef msg_command_long < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,param1,param2,param3,param4,param5,param6,param7,command,target_system,target_component,confirmation,varargin)

            if nargin == 11 + 1
                msg = msg_command_long(param1,param2,param3,param4,param5,param6,param7,command,target_system,target_component,confirmation,varargin);
            elseif nargin == 2
                msg = msg_command_long(param1);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_command_long.LEN);
