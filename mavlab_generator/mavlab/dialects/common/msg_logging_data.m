classdef msg_logging_data < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,sequence,target_system,target_component,length,first_message_offset,data,varargin)
            ...
            if nargin == 6 + 1
                msg = msg_logging_data(sequence,target_system,target_component,length,first_message_offset,data,varargin);
            elseif nargin == 2
                msg = msg_logging_data(sequence);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_logging_data.LEN);
