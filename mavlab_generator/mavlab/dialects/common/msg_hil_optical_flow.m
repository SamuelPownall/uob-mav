classdef msg_hil_optical_flow < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,time_usec,integration_time_us,integrated_x,integrated_y,integrated_xgyro,integrated_ygyro,integrated_zgyro,time_delta_distance_us,distance,temperature,sensor_id,quality,varargin)
            ...
            if nargin == 12 + 1
                msg = msg_hil_optical_flow(time_usec,integration_time_us,integrated_x,integrated_y,integrated_xgyro,integrated_ygyro,integrated_zgyro,time_delta_distance_us,distance,temperature,sensor_id,quality,varargin);
            elseif nargin == 2
                msg = msg_hil_optical_flow(time_usec);
            else
    ...
    methods
        ...
        %MSG_HIL_OPTICAL_FLOW: Create a new hil_optical_flow message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_hil_optical_flow.LEN);
