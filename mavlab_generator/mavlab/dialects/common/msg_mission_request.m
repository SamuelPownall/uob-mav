classdef msg_mission_request < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,seq,target_system,target_component,varargin)
            ...
            if nargin == 3 + 1
                msg = msg_mission_request(seq,target_system,target_component,varargin);
            elseif nargin == 2
                msg = msg_mission_request(seq);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_mission_request.LEN);
