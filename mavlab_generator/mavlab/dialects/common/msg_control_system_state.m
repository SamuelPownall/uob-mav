classdef msg_control_system_state < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,time_usec,x_acc,y_acc,z_acc,x_vel,y_vel,z_vel,x_pos,y_pos,z_pos,airspeed,vel_variance,pos_variance,q,roll_rate,pitch_rate,yaw_rate,varargin)

            if nargin == 17 + 1
                msg = msg_control_system_state(time_usec,x_acc,y_acc,z_acc,x_vel,y_vel,z_vel,x_pos,y_pos,z_pos,airspeed,vel_variance,pos_variance,q,roll_rate,pitch_rate,yaw_rate,varargin);
            elseif nargin == 2
                msg = msg_control_system_state(time_usec);
            else
    ...
    methods
        ...
        %MSG_CONTROL_SYSTEM_STATE: Create a new control_system_state message object
            ...
            elseif nargin >= 17 && isempty(varargin{1})
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_control_system_state.LEN);
