classdef msg_vicon_position_estimate < MAVLinkMessage
	%MSG_VICON_POSITION_ESTIMATE: MAVLink Message ID = 104
    %Description:
    ...
    methods(Static)
        ...
        function send(out,usec,x,y,z,roll,pitch,yaw,varargin)
            ...
            if nargin == 7 + 1
                msg = msg_vicon_position_estimate(usec,x,y,z,roll,pitch,yaw,varargin);
            elseif nargin == 2
                msg = msg_vicon_position_estimate(usec);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_vicon_position_estimate.LEN);
