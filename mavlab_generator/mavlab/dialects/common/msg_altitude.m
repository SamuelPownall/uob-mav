classdef msg_altitude < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,time_usec,altitude_monotonic,altitude_amsl,altitude_local,altitude_relative,altitude_terrain,bottom_clearance,varargin)

            if nargin == 7 + 1
                msg = msg_altitude(time_usec,altitude_monotonic,altitude_amsl,altitude_local,altitude_relative,altitude_terrain,bottom_clearance,varargin);
            elseif nargin == 2
                msg = msg_altitude(time_usec);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_altitude.LEN);
