classdef msg_global_vision_position_estimate < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,usec,x,y,z,roll,pitch,yaw,varargin)
            ...
            if nargin == 7 + 1
                msg = msg_global_vision_position_estimate(usec,x,y,z,roll,pitch,yaw,varargin);
            elseif nargin == 2
                msg = msg_global_vision_position_estimate(usec);
            else
    ...
    methods
        ...
        %MSG_GLOBAL_VISION_POSITION_ESTIMATE: Create a new global_vision_position_estimate message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_global_vision_position_estimate.LEN);
