classdef msg_command_int < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,param1,param2,param3,param4,x,y,z,command,target_system,target_component,frame,current,autocontinue,varargin)

            if nargin == 13 + 1
                msg = msg_command_int(param1,param2,param3,param4,x,y,z,command,target_system,target_component,frame,current,autocontinue,varargin);
            elseif nargin == 2
                msg = msg_command_int(param1);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_command_int.LEN);
