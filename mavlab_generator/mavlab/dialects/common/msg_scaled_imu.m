classdef msg_scaled_imu < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,time_boot_ms,xacc,yacc,zacc,xgyro,ygyro,zgyro,xmag,ymag,zmag,varargin)
            ...
            if nargin == 10 + 1
                msg = msg_scaled_imu(time_boot_ms,xacc,yacc,zacc,xgyro,ygyro,zgyro,xmag,ymag,zmag,varargin);
            elseif nargin == 2
                msg = msg_scaled_imu(time_boot_ms);
            else
    ...
    methods
        ...
        %MSG_SCALED_IMU: Create a new scaled_imu message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_scaled_imu.LEN);
