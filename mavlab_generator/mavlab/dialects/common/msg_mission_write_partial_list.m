classdef msg_mission_write_partial_list < MAVLinkMessage
	%MSG_MISSION_WRITE_PARTIAL_LIST: MAVLink Message ID = 38
    %Description:
    ...
    methods(Static)
        ...
        function send(out,start_index,end_index,target_system,target_component,varargin)
            ...
            if nargin == 4 + 1
                msg = msg_mission_write_partial_list(start_index,end_index,target_system,target_component,varargin);
            elseif nargin == 2
                msg = msg_mission_write_partial_list(start_index);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_mission_write_partial_list.LEN);
