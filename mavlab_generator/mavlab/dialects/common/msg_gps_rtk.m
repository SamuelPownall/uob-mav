classdef msg_gps_rtk < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,time_last_baseline_ms,tow,baseline_a_mm,baseline_b_mm,baseline_c_mm,accuracy,iar_num_hypotheses,wn,rtk_receiver_id,rtk_health,rtk_rate,nsats,baseline_coords_type,varargin)
            ...
            if nargin == 13 + 1
                msg = msg_gps_rtk(time_last_baseline_ms,tow,baseline_a_mm,baseline_b_mm,baseline_c_mm,accuracy,iar_num_hypotheses,wn,rtk_receiver_id,rtk_health,rtk_rate,nsats,baseline_coords_type,varargin);
            elseif nargin == 2
                msg = msg_gps_rtk(time_last_baseline_ms);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_gps_rtk.LEN);
