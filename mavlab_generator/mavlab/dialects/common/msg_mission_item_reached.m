classdef msg_mission_item_reached < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,seq,varargin)
            ...
            if nargin == 1 + 1
                msg = msg_mission_item_reached(seq,varargin);
            elseif nargin == 2
                msg = msg_mission_item_reached(seq);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_mission_item_reached.LEN);
