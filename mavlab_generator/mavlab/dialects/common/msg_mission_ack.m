classdef msg_mission_ack < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,target_system,target_component,type,varargin)

            if nargin == 3 + 1
                msg = msg_mission_ack(target_system,target_component,type,varargin);
            elseif nargin == 2
                msg = msg_mission_ack(target_system);
            else
    ...
    methods
        ...
        %MSG_MISSION_ACK: Create a new mission_ack message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_mission_ack.LEN);
