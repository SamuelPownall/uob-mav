classdef msg_mission_item_int < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,param1,param2,param3,param4,x,y,z,seq,command,target_system,target_component,frame,current,autocontinue,varargin)
            ...
            if nargin == 14 + 1
                msg = msg_mission_item_int(param1,param2,param3,param4,x,y,z,seq,command,target_system,target_component,frame,current,autocontinue,varargin);
            elseif nargin == 2
                msg = msg_mission_item_int(param1);
            else
    ...
    methods
        ...
        function obj = msg_mission_item_int(param1,param2,param3,param4,x,y,z,seq,command,target_system,target_component,frame,current,autocontinue,varargin)
        %MSG_MISSION_ITEM_INT: Create a new mission_item_int message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_mission_item_int.LEN);
