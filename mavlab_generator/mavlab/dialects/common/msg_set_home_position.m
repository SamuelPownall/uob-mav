classdef msg_set_home_position < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,latitude,longitude,altitude,x,y,z,q,approach_x,approach_y,approach_z,target_system,varargin)

            if nargin == 11 + 1
                msg = msg_set_home_position(latitude,longitude,altitude,x,y,z,q,approach_x,approach_y,approach_z,target_system,varargin);
            elseif nargin == 2
                msg = msg_set_home_position(latitude);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_set_home_position.LEN);
