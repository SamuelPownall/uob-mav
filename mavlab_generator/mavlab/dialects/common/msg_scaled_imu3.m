classdef msg_scaled_imu3 < MAVLinkMessage
	%MSG_SCALED_IMU3: MAVLink Message ID = 129
    %Description:
    ...
    methods(Static)
        ...
        function send(out,time_boot_ms,xacc,yacc,zacc,xgyro,ygyro,zgyro,xmag,ymag,zmag,varargin)
            ...
            if nargin == 10 + 1
                msg = msg_scaled_imu3(time_boot_ms,xacc,yacc,zacc,xgyro,ygyro,zgyro,xmag,ymag,zmag,varargin);
            elseif nargin == 2
                msg = msg_scaled_imu3(time_boot_ms);
            else
    ...
    methods
        ...
        function obj = msg_scaled_imu3(time_boot_ms,xacc,yacc,zacc,xgyro,ygyro,zgyro,xmag,ymag,zmag,varargin)
        %MSG_SCALED_IMU3: Create a new scaled_imu3 message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_scaled_imu3.LEN);
