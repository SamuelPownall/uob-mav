classdef msg_position_target_local_ned < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,time_boot_ms,x,y,z,vx,vy,vz,afx,afy,afz,yaw,yaw_rate,type_mask,coordinate_frame,varargin)

            if nargin == 14 + 1
                msg = msg_position_target_local_ned(time_boot_ms,x,y,z,vx,vy,vz,afx,afy,afz,yaw,yaw_rate,type_mask,coordinate_frame,varargin);
            elseif nargin == 2
                msg = msg_position_target_local_ned(time_boot_ms);
            else
    ...
    methods
        ...
        %MSG_POSITION_TARGET_LOCAL_NED: Create a new position_target_local_ned message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_position_target_local_ned.LEN);
