classdef msg_mission_clear_all < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,target_system,target_component,varargin)
            ...
            if nargin == 2 + 1
                msg = msg_mission_clear_all(target_system,target_component,varargin);
            elseif nargin == 2
                msg = msg_mission_clear_all(target_system);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_mission_clear_all.LEN);
