classdef msg_set_actuator_control_target < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,time_usec,controls,group_mlx,target_system,target_component,varargin)

            if nargin == 5 + 1
                msg = msg_set_actuator_control_target(time_usec,controls,group_mlx,target_system,target_component,varargin);
            elseif nargin == 2
                msg = msg_set_actuator_control_target(time_usec);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_set_actuator_control_target.LEN);
