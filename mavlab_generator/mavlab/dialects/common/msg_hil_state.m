classdef msg_hil_state < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,time_usec,roll,pitch,yaw,rollspeed,pitchspeed,yawspeed,lat,lon,alt,vx,vy,vz,xacc,yacc,zacc,varargin)

            if nargin == 16 + 1
                msg = msg_hil_state(time_usec,roll,pitch,yaw,rollspeed,pitchspeed,yawspeed,lat,lon,alt,vx,vy,vz,xacc,yacc,zacc,varargin);
            elseif nargin == 2
                msg = msg_hil_state(time_usec);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_hil_state.LEN);
