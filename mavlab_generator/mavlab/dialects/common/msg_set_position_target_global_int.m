classdef msg_set_position_target_global_int < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,time_boot_ms,lat_int,lon_int,alt,vx,vy,vz,afx,afy,afz,yaw,yaw_rate,type_mask,target_system,target_component,coordinate_frame,varargin)

            if nargin == 16 + 1
                msg = msg_set_position_target_global_int(time_boot_ms,lat_int,lon_int,alt,vx,vy,vz,afx,afy,afz,yaw,yaw_rate,type_mask,target_system,target_component,coordinate_frame,varargin);
            elseif nargin == 2
                msg = msg_set_position_target_global_int(time_boot_ms);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_set_position_target_global_int.LEN);
