classdef msg_scaled_pressure < MAVLinkMessage
	%MSG_SCALED_PRESSURE: MAVLink Message ID = 29
    %Description:
    ...
    methods(Static)
        ...
        function send(out,time_boot_ms,press_abs,press_diff,temperature,varargin)
            ...
            if nargin == 4 + 1
                msg = msg_scaled_pressure(time_boot_ms,press_abs,press_diff,temperature,varargin);
            elseif nargin == 2
                msg = msg_scaled_pressure(time_boot_ms);
            else
    ...
    methods
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_scaled_pressure.LEN);
