classdef msg_set_attitude_target < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,time_boot_ms,q,body_roll_rate,body_pitch_rate,body_yaw_rate,thrust,target_system,target_component,type_mask,varargin)

            if nargin == 9 + 1
                msg = msg_set_attitude_target(time_boot_ms,q,body_roll_rate,body_pitch_rate,body_yaw_rate,thrust,target_system,target_component,type_mask,varargin);
            elseif nargin == 2
                msg = msg_set_attitude_target(time_boot_ms);
            else
    ...
    methods
        ...
        function obj = msg_set_attitude_target(time_boot_ms,q,body_roll_rate,body_pitch_rate,body_yaw_rate,thrust,target_system,target_component,type_mask,varargin)
        %MSG_SET_ATTITUDE_TARGET: Create a new set_attitude_target message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_set_attitude_target.LEN);
