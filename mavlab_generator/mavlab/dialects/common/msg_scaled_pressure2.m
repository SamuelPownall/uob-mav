classdef msg_scaled_pressure2 < MAVLinkMessage
    ...
    methods(Static)
        ...
        function send(out,time_boot_ms,press_abs,press_diff,temperature,varargin)
            ...
            if nargin == 4 + 1
                msg = msg_scaled_pressure2(time_boot_ms,press_abs,press_diff,temperature,varargin);
            elseif nargin == 2
                msg = msg_scaled_pressure2(time_boot_ms);
            else
    ...
    methods
        ...
        function obj = msg_scaled_pressure2(time_boot_ms,press_abs,press_diff,temperature,varargin)
        %MSG_SCALED_PRESSURE2: Create a new scaled_pressure2 message object
        ...
        %    for transmission.
            ...
            if errorField == 0
                ...
                packet = MAVLinkPacket(msg_scaled_pressure2.LEN);
